...
def receive_message(client, queue_url, message_attribute_names=None, num_of_message=None):
...
def test_do_receive_message(client, num_of_message):
    ...
    with mock.patch("uuid.uuid4", return_value="725275ae-0b9b-4762-b238-436d7c65a1ac"), \
        ...
        assert receive_message(
            client, "http://localhost:5000/queues/test_receive_queue", num_of_message=num_of_message
        ).data == dict2xml_bytes(
            {
